...
def decide_signal(symbol, price, orderbook=None):
    """
    ورودی: قیمت لحظه‌ای و (اختیاری) orderbook
    خروجی: dict شامل signal_type، target، stop
    """
    # مثال ساده: اگر قیمت کمتر از 20 روز گذشته باشد → buy
    # اینجا فقط یک نمونهٔ تستی است
    if price < 100:
